...
공용컴포넌트 : FloatUpLabel
참고urls : 
  https://play.nativescript.org/?template=play-vue&id=WlzgRU&v=10
...
<GridLayout rows="30, auto" marginBottom="5">
    ...
    <TextField ref="textField" :secure="secure" row="1"  @focus="onFocus" @blur="onBlur" borderBottomWidth="3" borderBottomColor="#cec8c8" padding="0" />
</GridLayout>
</template>
